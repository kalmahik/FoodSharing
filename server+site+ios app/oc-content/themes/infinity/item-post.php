                ...
                <form name="item" action="<?php echo osc_base_url(true);?>" method="post" enctype="multipart/form-data" id="item-post">
                    ...
                    <?php } ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php ItemForm::category_select(null, null, __('Select a category', 'infinity')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="price"><?php _e('Price', 'infinity'); ?></label>
                            <div class="controls">
...
<?php } ?>
                        <div class="box location">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="cityArea"><?php _e('City Area', 'infinity'); ?></label>
                                <div class="controls">
