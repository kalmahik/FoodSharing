<?php
    ...
    infinity_add_body_class('search');
    $listClass = '';
    $buttonClass = '';
     ...
     <div class="list-header">
        <div class="resp-wrapper">
            ...
            <span class="counter-search"><?php
                $search_number = infinity_search_number();
                printf(__('%1$d - %2$d of %3$d listings', 'infinity'), $search_number['from'], $search_number['to'], $search_number['of']);
            ?></span>
            <div class="actions">
              <a href="#" data-bclass-toggle="display-filters" class="resp-toogle show-filters-btn"><?php _e('Show filters','infinity'); ?></a>
              <span class="doublebutton <?php echo $buttonClass; ?>">
                   <a href="<?php echo osc_esc_html(osc_update_search_url(array('sShowAs'=> 'list'))); ?>" class="list-button" data-class-toggle="listing-grid" data-destination="#listing-card-list"><span><?php _e('List','infinity'); ?></span></a>
                   <a href="<?php echo osc_esc_html(osc_update_search_url(array('sShowAs'=> 'gallery'))); ?>" class="grid-button" data-class-toggle="listing-grid" data-destination="#listing-card-list"><span><?php _e('Grid','infinity'); ?></span></a>
              </span>
            <!--     START sort by       -->
            <span class="see_by">
        ...
        <?php
            ...
            echo '<h5>'.__('Premium listings','infinity').'</h5>';
        ...
        ?>
     <?php if(osc_count_items() > 0) {
        echo '<h5>'.__('Listings','infinity').'</h5>';
