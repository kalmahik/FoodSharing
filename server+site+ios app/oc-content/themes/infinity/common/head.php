<?php
    $js_lang = array(
        'delete' => __('Delete', 'infinity'),
        'cancel' => __('Cancel', 'infinity')
    );
...
<script type="text/javascript">
    ...
    infinity.base_url = '<?php echo osc_base_url(true); ?>';
    infinity.langs = <?php echo json_encode($js_lang); ?>
</script>
<link href="<?php echo osc_current_web_theme_url('css/infinity.css') ; ?>?<?php echo rand(0, pow(10, 5)); ?>" rel="stylesheet" type="text/css" />
